...
public class OutputActivity extends AppCompatActivity {
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            target = "http://10.0.2.2:8080/List.php";
        }
        ...
        protected void onPostExecute(String result) {
            Intent intent = new Intent(OutputActivity.this, ManagementActivity.class);
            intent.putExtra("userList", result);//파싱한 값을 넘겨줌
            OutputActivity.this.startActivity(intent);//ManagementActivity로 넘어감
